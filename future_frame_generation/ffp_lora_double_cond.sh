...
export DATA_PATH="data_prep/one_sample_test/target_frames"
export COND_PATH="data_prep/one_sample_test/previous_frames"
export COND_PATH2="data_prep/one_sample_test/prev_previous_frames"
